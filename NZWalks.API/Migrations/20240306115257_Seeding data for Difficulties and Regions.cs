    ...
    public partial class SeedingdataforDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1f0b897b-ae04-406a-b02c-5d2042e26fa9"), "Easy" },
                    { new Guid("716889e9-8941-4295-b5cc-b7f317333c1f"), "Medium" },
                    { new Guid("7561250a-0c9e-4cb5-a6d4-3def289d92d2"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("1f0b897b-ae04-406a-b02c-5d2042e26fa9"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("716889e9-8941-4295-b5cc-b7f317333c1f"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("7561250a-0c9e-4cb5-a6d4-3def289d92d2"));
